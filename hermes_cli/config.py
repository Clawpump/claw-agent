...
# Apply downstream defaults and environment metadata after loading the
# upstream-owned pure-data module. The overlay is idempotent and is a no-op in
# distributions that do not ship it.
try:
