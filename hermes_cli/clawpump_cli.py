...
ClawPump ships its full feature set (126 tools) as an MCP server, bundled in
...
def _cmd_setup(args) -> int:
    ...
    print("  ClawPump's 126 tools (agents, trading, perps, DCA, lending,")
...
def add_parser(subparsers) -> None:
    ...
    clawpump_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "of its 126 tools are enabled. Subcommands: setup (default: status), "
            "login, status, tools."
        ),
    )
