 ...
 *
 * A public install can end up with `origin=git@github.com:Clawpump/claw-agent.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/Clawpump/claw-agent.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/clawpump/claw-agent'
