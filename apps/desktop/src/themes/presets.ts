...
/**
 * Claw Agent — the ClawPump desktop identity, built on Hermes by Nous
 * Research. GitHub chrome carries the ClawPump green accent while preserving
 * the upstream theme's neutral surfaces and terminal palette.
 */
export const nousTheme: DesktopTheme = {
  name: 'nous',
  label: 'Claw Agent',
  description: 'GitHub chrome, ClawPump green accent',
  colors: {
    background: '#ffffff',
    foreground: '#1f2328',
    card: '#f6f8fa',
