...
export const en: Translations = {
  ...
  boot: {
    ...
    steps: {
      ...
      retryingRemoteBackend: 'Reconnecting to the remote Claw Agent backend…',
  ...
  settings: {
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Claw Agent backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
        ...
        updateBackendToManage: 'Update the Claw Agent backend to manage this plugin from Desktop.',
    ...
    notifications: {
      ...
      kinds: {
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while Claw Agent was in the background.'
        }
      },
    ...
    appearance: {
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Claw Agent can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Claw Agent is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Claw Agent, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Claw Agent runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Claw Agent.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Claw Agent gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      kindSsh: 'SSH',
      kindLocalDesc: 'The Claw Agent runtime managed by this app.',
      kindRemoteDesc: 'A Claw Agent gateway reachable over HTTP(S) — LAN, Tailscale, or the internet.',
      kindCloudDesc: 'A hosted instance discovered through your Hermes Cloud account.',
      kindSshDesc: 'A Claw Agent install reached over SSH.',
      labelTitle: 'Name',
      ...
      headersDesc:
        'Sent with every HTTP and WebSocket request to this gateway — for access proxies such as Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Values are stored encrypted. Headers Claw Agent manages (Authorization, Cookie, Host…) are ignored.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a Claw Agent backend elsewhere. Gateway connections are machine-level; profiles are discovered from the gateways you connect.',
      ...
      remoteDesc: 'Connect this desktop shell to a remote Claw Agent backend.',
      ...
      restartingMessage: 'Claw Agent Desktop will reconnect using the saved settings — the shell stays open.',
      ...
      sshDesc:
        'Claw Agent is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Claw Agent path (optional)',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Claw Agent found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Claw Agent runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Claw Agent is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Claw Agent path.',
      sshErrPlatform:
        'Unsupported remote platform. Claw Agent Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Claw Agent on the remote host before connecting with Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'A link asked to add this MCP server to Claw Agent. Review the exact configuration below — it comes from the link, not from Claw Agent.',
    ...
    providers: {
      ...
      localEndpoint: {
        ...
        description: 'Point Claw Agent at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  starmap: {
    ...
    emptyDesc: 'As Claw Agent builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Claw Agent to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Claw Agent to generate pets.',
      backgroundHint: 'You can close this — Claw Agent will notify you when it’s done.',
  ...
  cron: {
    ...
    modelImpact: {
      ...
      saveFailed: 'Claw Agent did not save that model change.'
    },
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the Claw Agent backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Claw Agent. Files, git repos, and worktrees stay untouched.',
      ...
      worktreeStaleBackend:
        'Update the Claw Agent backend to create worktrees over this remote connection — it predates the git worktree API.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask Claw Agent to open PR',
  ...
  updates: {
    ...
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Claw Agent desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Claw Agent updater takes over in its own window and reopens Claw Agent automatically when it’s done. Please don’t reopen Claw Agent yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Claw Agent reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Claw Agent reopens on its own.',
    errorTitle: 'Update didn’t finish',
    errorBody: 'No worries — nothing was lost. You can try again now.',
    blockerTitle: 'Close local previews to update Claw Agent?',
    blockerBody:
      'Claw Agent needs to stop these local previews before updating. This will not modify or delete your files.',
    foreignBlockerTitle: 'Close other processes to update Claw Agent',
    foreignBlockerBody:
      'Claw Agent can’t safely close these processes automatically. Close the app, terminal, or service that owns each one, then try the update again.',
    mixedBlockerBody:
      'Claw Agent can close the local previews listed below. Other processes must be closed manually before the update can continue.',
  ...
  install: {
    ...
    setupChoiceTitle: 'Set up Claw Agent Desktop',
    setupChoiceDesc:
      'Connect this app to a Claw Agent gateway you already run, or install Claw Agent locally on this computer.',
    connectExistingTitle: 'Connect to existing Claw Agent',
    ...
    installLocalTitle: 'Install Claw Agent locally',
    ...
    probeError: 'Could not reach that Claw Agent gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up Claw Agent Agent',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Claw Agent Agent",
