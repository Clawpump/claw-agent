...
$RepoUrlSsh = "git@github.com:Clawpump/claw-agent.git"
$RepoUrlHttps = "https://github.com/Clawpump/claw-agent.git"
$PythonVersion = "3.11"
    ...
    if (Test-Path $InstallDir) {
        ...
        if ($repoValid) {
            ...
            try {
                ...
                if ($currentOrigin -match "(?i)nousresearch/hermes-agent") {
    ...
    if (-not $didUpdate) {
        ...
        if (-not $cloneSuccess) {
            ...
            try {
                ...
                if ($Commit) {
                    $zipUrl = "https://github.com/Clawpump/claw-agent/archive/$Commit.zip"
                    $zipLabel = $Commit
                } elseif ($Tag) {
                    $zipUrl = "https://github.com/Clawpump/claw-agent/archive/refs/tags/$Tag.zip"
                    $zipLabel = $Tag
                } else {
                    $zipUrl = "https://github.com/Clawpump/claw-agent/archive/refs/heads/$Branch.zip"
                    $zipLabel = $Branch
                }
...
try {
    ...
    Write-Host "  Invoke-WebRequest -Uri 'https://raw.githubusercontent.com/Clawpump/claw-agent/main/scripts/install.ps1' -OutFile install.ps1" -ForegroundColor Yellow
