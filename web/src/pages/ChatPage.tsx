...
export default function ChatPage({ isActive = true }: { isActive?: boolean }) {
  ...
  useLayoutEffect(() => {
    // Only the active chat route owns this header slot. The cleanup from the
    // previous active render clears it when another dashboard page takes over.
    if (!isActive) return;
    if (narrow) {
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-2 lg:flex-row lg:gap-3">
        ...
        {!narrow && !chatPanelCollapsed && (
          ...
          >
            ...
            {/* Model controls live in the desktop header; the rail is the
